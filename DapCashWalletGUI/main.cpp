...
int main(int argc, char *argv[])
{
    ...
    app.setApplicationName("DapCash Wallet");
...
//#ifndef QT_DEBUG
    #ifdef Q_OS_LINUX
        dapLogger.setLogFile(QString("/opt/dapcash-wallet/log/%1Gui.log").arg(DAP_BRAND));
    #elif defined Q_OS_MACOS
	mkdir("/tmp/cellframe-dashboard_log",0777);
    dapLogger.setLogFile(QString("/tmp/dapcash-wallet/%1Gui.log").arg(DAP_BRAND));
